...
- The backend owns control-plane work today: `GET /health`, `POST /session/token`, and `/chat-memory/*` persistence routes; checkpointing, backend tools, and error reporting remain planned.
