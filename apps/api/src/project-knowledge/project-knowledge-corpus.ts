...
export const PROJECT_KNOWLEDGE_CORPUS_MANIFEST: readonly ProjectKnowledgeCorpusManifestEntry[] = [
  ...
  { id: 'chat-memory-wave1', relativePath: 'docs/CHAT_MEMORY_POSTGRES_WAVE_1.md' },
  { id: 'specs-readme', relativePath: 'specs/README.md' },
  { id: 'release-1-real-token', relativePath: 'specs/release-1-real-token-issuance.md' },
